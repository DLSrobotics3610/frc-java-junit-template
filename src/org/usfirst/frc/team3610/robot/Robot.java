...
import org.usfirst.frc.team3610.robot.commands.ExampleCommand;
import org.usfirst.frc.team3610.robot.subsystems.ExampleSubsystem;
...
public class Robot extends IterativeRobot {
	...
	public void autonomousPeriodic() {
		...
		while (isAutonomous() && isEnabled() && (Timer < 5.00)) {
	...
	public void operatorControl() {
    	while (isOperatorControl() && isEnabled()) {
    		myDrive.tankDrive(oi.left, oi.right);
    		Timer.delay(0.01);	
    	}
	}
